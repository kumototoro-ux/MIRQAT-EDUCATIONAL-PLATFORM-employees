...
- ✅ إدارة الطلاب (`api/students.js`) — مقيّد بنطاق المعلم تلقائيًا
- ✅ إدارة الموظفين (`api/employees.js`) — أدمن فقط
- ⏳ باقي الميزات (الجدول، التحضير، التكاليف، الإثراءات، الدرجات، السلوك،
  التقارير، سجل التتبع) — ميزة واحدة في كل مرة (3 ملفات API من أصل 12 حتى الآن)
